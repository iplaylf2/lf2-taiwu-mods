...
namespace Unfathomed.Backend.RandomCompletion;

[HarmonyPatch(typeof(RedzenHelper))]
internal static class RedzenHelperPatcher
{
    [HarmonyPrefix]
    [HarmonyPatch(nameof(RedzenHelper.SkewDistribute))]
    private static bool SkewDistribute
    (
        ref int __result,
    ...
    private static int SkewDistribute
    (
        IRandomSource randomSource,
        float mean,
        float stdDev,
